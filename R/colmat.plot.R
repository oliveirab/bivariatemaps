...
colmat.plot<-function(nquantiles=10, upperleft="blue", upperright="red", bottomleft="grey", bottomright="yellow", xlab="x label", ylab="y label", cex=0.5, cex.lab=1.3,cex.axis=1){
  my.data<-seq(0,1,.01)
  ...
  plot(c(1,1),pch=19,col=my.pal.1, cex=cex,xlim=c(0,1),ylim=c(0,1),frame.plot=F, xlab=xlab, ylab=ylab,cex.lab=cex.lab,cex.axis=cex.axis)
  for(i in 1:101){
